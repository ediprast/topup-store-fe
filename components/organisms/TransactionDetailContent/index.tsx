          ...
          <div className="main-content main-content-card overflow-auto">
            <section className="checkout mx-auto">
              ...
              <div className="purchase pt-30">
                ...
                <Row
                  label="Price"
                  value={`Rp ${data.historyVoucherTopup.price}`}
                />
                <Row label="Tax (10%)" value={`Rp ${data.tax}`} />
                <Row
                  label="Total"
                  value={`Rp ${data.value}`}
              ...
              <div className="d-md-block d-flex flex-column w-100">
                <a
                  ...
                  href="https://wa.me/11234567890?text=I'm%20interested%20in%20your%20car%20for%20sale"
                  role="button"
                >
                  WhatsApp ke Admin
                </a>
